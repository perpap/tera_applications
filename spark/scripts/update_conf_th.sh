...
update_spark_defaults() {
	...
	extra_java_opts+="-XX:-ClassUnloading -XX:DEVICE_H2=\"nvme0n1p1\" -XX:+UseParallelGC -XX:ParallelGCThreads=${GC_THREADS} "
	#extra_java_opts+="-XX:-ClassUnloading -XX:DEVICE_H2=\"nvme0n1p1\" -XX:+UseParallelGC -XX:+UseNUMA -XX:ParallelGCThreads=${GC_THREADS} "
